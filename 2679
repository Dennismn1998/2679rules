2679 NON-AGGRESSION PACT (NAP) RULES 2.0
1.	NAP includes the TOP 5 alliances in power. If the power of an existing member drops below 5, they have 24 hours to get their power up to stay in NAP.
...
6.	State Presidency is rotated amongst the TOP 3 alliances in the state. Presidency Candidates will have to be announced 24 hours before SFC/SVS in NAP Chat. If any TOP 3 alliance would like to opt out or skip to be President for a particular round, they have to inform NAP chat at least 48 hours before the SFC/SVS battle. The Presidency will then be passed on to the next one in rotation.
...
1. Members
•	NAP covers the Top 5 alliances in power.
...
1.	Top 5 Only – NAP = Top 5 alliances. Drop below? 24h to recover.
...
6.	Presidency – Rotates between Top 3. Announce candidate 24h before battle; if skip = inform 48h before.
